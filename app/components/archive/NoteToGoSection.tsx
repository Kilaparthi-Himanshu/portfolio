...
export default function NoteToGoSection() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative notetogo h-screen w-full overflow-hidden bg-stone-800 text-white"
    ...
    >
      ...
      <div className="intro-wrapper max-lg:mt-8 absolute text-center flex flex-col items-center justify-center">
        <h1 className="ntg-title tracking-tight text-[56px] sm:text-[60px] md:text-[80px] lg:text-[110px] xl:text-[160px]">
          NoteToGo
        </h1>
